    ...
    <div class="main-container container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <span class="main-content-title mg-b-0 mg-b-lg-1">Reporte de Ventas por productos</span>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div id="filtroVentas">
                            <form action="{{ route('reportes.ventas-productos') }}" method="GET">
                                <div class="row pb-4">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="{{ route('reportes.ventas-productos-excel', ['searchFechaInicio' => $fechaInicio2, 'searchFechaFin' => $fechaFin2,  'searchCliente' => $searchCliente2]) }}" target="_blank" class="btn btn-success mt-4 mr-2">
                                            <i data-bs-toggle="tooltip" data-bs-title="Excel" class="fas fa-file"></i><b>
                                                &nbsp; Excel</b>
                                        </a>
                                        <a href="{{ route('reportes.ventas-productos-pdf', ['searchFechaInicio' => $fechaInicio2, 'searchFechaFin' => $fechaFin2,  'searchCliente' => $searchCliente2]) }}" target="_blank" class="btn btn-danger mt-4 ">
