...
<div class="main-container container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">Listado de Cajas</span>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{route('caja.show',$caja)}}" >Ver Detalles</a></li>
                                                @if(Gate::check('caja.edit') && $caja->estado == 1)
                                                    <li><a class="dropdown-item" onclick="editar('{{$caja->id}}','{{$caja->user_id}}','{{$caja->totalApertura}}','{{$caja->observacion}}')">Editar</a></li>
                                                @endif
                                                @if(Gate::check('caja.cerrar') && $caja->estado == 1)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('caja.cerrar')}}" method="POST" autocomplete="off">
                    {{csrf_field()}}
                    <div class="mb-3" >
                        <input type="hidden" name="id_caja" id="id_caja" value="{{old('id_caja')}}" id="paymentForm2">
...
<div class="modal fade" id="crear-formulario"  aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('caja.store')}}" method="POST" autocomplete="off" id="paymentForm">
                    {{csrf_field()}}
                    <div class="mb-3">
