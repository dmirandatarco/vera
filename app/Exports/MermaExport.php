...
class MermaExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings
{
    use Exportable;

    public function __construct(public $mermas,public $fechaFin2, public $fechaInicio2)
    {
    }
    ...
    public function view(): View
    {
        ...
        return view('pages.excel.mermas-excel', compact('mermas','fechaFin2','fechaInicio2'));
    }
}
