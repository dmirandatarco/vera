...
class VentasExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('pages.excel.ventasexcel', compact('ventas','fechaFin2','fechaInicio2','nume_documento2','searchResponsable2','searchCliente2','searchDocumento2'));
    }
}
