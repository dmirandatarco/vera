...
class SeriesExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings
{
    use Exportable;

    public function __construct(public $ventas,public $fechaFin2, public $fechaInicio2)
    {
    }
    ...
    public function view(): View
    {
        ...
        return view('pages.excel.ventas-series-excel', compact('ventas','fechaFin2','fechaInicio2'));
    }
}
